<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoiNhuanChechLechGia.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.LoiNhuanChechLechGia" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách lợi nhuận chênh lệch giá</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách lợi nhuận chênh lệch giá</h4>
                            ...
                            <div class="row-fluid">
                                <div class="span9">
                                    ...
                                    <div class="dataTables_length" id="sample_1_length">
                                        ...
                                        <asp:DropDownList ID="ddlkieu"  Visible="false" CssClass="txt" AutoPostBack="true"
                                            runat="server" OnSelectedIndexChanged="ddlkieu_SelectedIndexChanged">
                                            <asp:ListItem Value="301">Tất cả loại Hoa Hồng</asp:ListItem>
                                        </asp:DropDownList>
