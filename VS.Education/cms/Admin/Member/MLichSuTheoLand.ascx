<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuTheoLand.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MLichSuTheoLand" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách 10% F1 theo agland</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp; Danh sách 10% F1 theo agland</h4>
                                ...
                                <asp:Repeater ID="rp_pagelist" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <%#ShowtThanhVien(DataBinder.Eval(Container.DataItem,"IDHuongF1").ToString())%>
                                            </td>
                                           
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"HoaHong")%> điểm
                                            </td>
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"PhanTramLai")%> %
                                            </td>
                                            <td>
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold; width: 200px">Người F1 hưởng</th>
