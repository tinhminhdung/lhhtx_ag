<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DonBanHang.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.DonBanHang" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<div class="page-title m992">
    <h1 class="title-head margin-top-0"><a href="#">Quản lý đơn bán hàng</a></h1>
</div>
                            ...
                            <ItemTemplate>
                                <tr class="first odd">
                                    <td style="text-align: left">
                                        <a style="color: red; font-weight: bold" title="Click vào để xem chi tiết đơn hàng" href="/orders-sold/<%#Eval("ID") %>">Mã đơn hàng:#<%#Eval("ID") %></a><br />
