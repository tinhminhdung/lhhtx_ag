<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLSCCapDiem.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MLSCCapDiem" %>
        ...
        <div class="widget">
            ...
            <div class="widget-body">
                <div class="row-fluid">
                    <div class="span12">
                        <div>
                            <asp:TextBox ID="txtkeyword" placeholder="Tìm kiếm theo tên User thành viên" runat="server" CssClass="txt_csssearch" Width="150px"></asp:TextBox>
                            <asp:DropDownList CssClass="txt" runat="server" ID="ddlkieuthanhvien">
                                <asp:ListItem Value="1">Admin cấp</asp:ListItem>
                                  <asp:ListItem Value="3">Admin cấp - vietdung</asp:ListItem>
                                 <asp:ListItem Value="4">Admin cấp - agadmin</asp:ListItem>
                                <asp:ListItem Value="2">Hệ thống</asp:ListItem>
                            </asp:DropDownList>
                             <asp:DropDownList ID="ddlvidiem" runat="server" OnTextChanged="ddlvidiem_TextChanged" AutoPostBack="true" ValidationGroup="GInfo">
                                  <asp:ListItem Value="0">-- Tất cả các ví --</asp:ListItem>
                    ...
                    <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                        <tbody>
                            <tr class="trHeader" style="height: 25px">
                                ...
                                <th style="font-weight: bold">Cấp ví</th>
