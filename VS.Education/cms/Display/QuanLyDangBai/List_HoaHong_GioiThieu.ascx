<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List_HoaHong_GioiThieu.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.List_HoaHong_GioiThieu" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
   <h1 class="title-head">
        <span>Danh sách hoa hồng quản lý</span>
    </h1>
                            ...
                            <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                <tbody>
                                    <tr class="trHeader" style="height: 25px">
                                        ...
                                        <th style="font-weight: bold">Người tham gia Đăng ký</th>
                                        <th style="font-weight: bold">Người được hưởng giới thiệu</th>
