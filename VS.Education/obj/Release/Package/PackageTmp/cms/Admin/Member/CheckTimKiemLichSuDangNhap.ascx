<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckTimKiemLichSuDangNhap.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.CheckTimKiemLichSuDangNhap" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Tìm lịch sử IP đăng nhập</span></li>
                    </ul>
                </div>
                <div style="clear: both;"></div>
                <div class="widget">
                    <div class="widget-title">
                        <h4><i class="icon-list-alt"></i>&nbsp;Tìm lịch sử IP đăng nhập</h4>
                    </div>
                                ...
                                <ItemTemplate>
                                    <tr>
                                        <td style="text-align: center;">
                                         ...
                                         <td>
                                                <%#ShowtThanhVien(DataBinder.Eval(Container.DataItem,"ThanhVien").ToString())%>
                                            </td>
                                        <td style="text-align: center;">
