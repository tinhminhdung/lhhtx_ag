<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CDaiLy.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.CDaiLy" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách các chi nhánh</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách các chi nhánh</h4>
                        ...
                        <div class="widget-body">
                            ...
                            <div class="list_item">
                                <asp:Label ID="lthongbao" runat="server" Font-Bold="True" ForeColor="Red" Visible="True"></asp:Label>
                                           ...
                                           <%-- <td style="text-align: center;" class="Imgsmall">
                                             ...
                                             <td>
                                               ...
                                               <%#DataBinder.Eval(Container.DataItem, "Name")%>
                                                 ...
                                                 <%#ShowtThanhVien(DataBinder.Eval(Container.DataItem,"Type").ToString())%><%--Type là ID thành viên nhé--%>
                                            </td>
                                                <td style="text-align: center;">
                                              <b style="color:red; font-weight:bold">Tổng: </b><%#ShowChiNhanh(DataBinder.Eval(Container.DataItem,"ID").ToString())%>
                                            </td>
                                               <td style="text-align: center;">
                                                <b style="color:red; font-weight:bold">Chưa Kích Hoạt: </b> <%#ShowChiNhanhChuaKH(DataBinder.Eval(Container.DataItem,"ID").ToString())%>
                                            </td>
                                             <td style="text-align: center;">
                                                <b style="color:red; font-weight:bold">Đã Kích Hoạt: </b><%#ShowChiNhanhDaKH(DataBinder.Eval(Container.DataItem,"ID").ToString())%>
                                            </td>
                                            <td style="text-align: center;">
                                            ...
                                            <td style="text-align: center;">
                                                <asp:LinkButton CssClass="active action-link-button" CommandName="ListChildren" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ID")%>' Visible="false" runat="server" ID="Linkbutton2" NAME="Linkbutton2"><i class="icon-plus"></i></asp:LinkButton>
                                            ...
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                   ...
                                                   <%--  <th style="font-weight: bold">Ảnh</th>--%>
                                                     <th style="font-weight: bold">Tên chi nhánh</th>
                                                             <th style="font-weight: bold">Chi nhánh thuộc</th>
                                                    <th style="font-weight: bold">Tổng số đăng ký</th>
                                                     <th style="font-weight: bold">Chưa kích hoạt</th>
                                                     <th style="font-weight: bold">Đã kích hoạt</th>
                            ...
                            <div class='frm-add'>
                                <table class="Tables">
                                    <tr>
                                      ...
                                      <br /> <asp:Label ID="ltthongtin" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
                                            <asp:HiddenField ID="hdidthanhvien" runat="server" />

                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">Tên chi nhánh
                                        </td>
                                        <td></td>
                                        <td>
