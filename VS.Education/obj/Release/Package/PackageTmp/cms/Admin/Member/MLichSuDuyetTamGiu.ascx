<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuDuyetTamGiu.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MLichSuDuyetTamGiu" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Lịch sử Duyệt tự động ví tạm giữ</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Lịch sử Duyệt tự động ví tạm giữ</h4>
                                ...
                                <asp:Repeater ID="rp_pagelist" runat="server">
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                                <div><%#ShowtThanhVien(Eval("IDThanhVienMua").ToString())%></div>
                                            </td>
                                            <td>
                                                <div><%#ShowtThanhVien(Eval("IDThanhVienNhaCC").ToString())%></div>
                                            </td>
                                            <td style="text-align: center;">
                                                <%#ShowPro(DataBinder.Eval(Container.DataItem,"IDSanPham").ToString())%>
                                                <div><a style="color: red" target="_blank" href="/admin.aspx?u=DetailCartNhanh&ID=<%#Eval("IDCarts") %>">Mã đơn hàng: #<%#DataBinder.Eval(Container.DataItem,"IDCarts").ToString()%> </a></div>
                                            </td>
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"SoDiemThanhToan")%> 
                                            </td>
                                            <td>
                                                <%#MoreAll.FormatDateTime.FormatDateFull(DataBinder.Eval(Container.DataItem,"NgayDuyet"))%> 
                                            </td>
                                            <td style="text-align: center;">
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold">Thành viên Mua</th>
                                                    <th style="font-weight: bold">Thành viên Bán</th>
                                                    <th style="font-weight: bold; text-align: center">Sản phẩm</th>
