<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuMuaDiem.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.MLichSuMuaDiem" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
            <div class="nentrang">
                <h1 class="title-head">
                    <span>Danh sách lịch sử mua điểm</span>
                </h1>
                                        ...
                                        <asp:Repeater ID="rp_pagelist" runat="server">
                                            <ItemTemplate>
                                                <tr>
                                                   ...
                                                   <td style="text-align: center;">
                                                        <%#MoreAll.FormatDateTime.FormatDate_Brithday(DataBinder.Eval(Container.DataItem,"NgayGui"))%> 
                                                    </td>
                                                       <td style="text-align: center;">
                                                    ...
                                                    <td style="text-align: center;">
                                                       ...
                                                       <td style="text-align: center;">
                                                        <%#(DataBinder.Eval(Container.DataItem,"GhiChu"))%> 
                                                    </td>
                                                </tr>
                                            </ItemTemplate>
                                            <HeaderTemplate>
                                                <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                                        <tr class="trHeader" style="height: 25px">
                                                            <th style="width: 4%; font-weight: bold;text-align:center" class="contentadmin">STT</th>
                                                               <th style="font-weight: bold; text-align:center">Số điểm cần mua</th>
