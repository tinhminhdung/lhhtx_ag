...
{
    public partial class MLichSuThanhToanQRCode : System.Web.UI.UserControl
    {
        public int i = 1;
        ...
        private void LoadItems()
        {
            ...
            string sqls = "SELECT * from LichSuThanhToanQRCode where 1=1 " + sql + "  order by NgayDuyet desc";
            List<LichSuThanhToanQRCode> table = db.ExecuteQuery<LichSuThanhToanQRCode>(@"" + sqls + "").ToList();
            if (table.Count > 0)
            {
                double coin = 0.0;
        ...
        void Show()
        {
            Response.Redirect("/lich-su-thanh-toan-qrcode.html?ngay=" + DropDownList1.SelectedValue + "&thang=" + DropDownList2.SelectedValue + "&nam=" + DropDownList3.SelectedValue + "");
        }
