<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuDuyetViTamGiu.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.MLichSuDuyetViTamGiu" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
            <div class="nentrang">
                <h1 class="title-head">
                    <span>Danh sách lịch sử tự động duyệt VÍ TẠM GIỮ BÁN HÀNG</span>
                </h1>
                                                    ...
                                                    <td style="text-align: center;">
                                                      ...
                                                      <td style="text-align: center;">
                                                         <%#ShowPro(DataBinder.Eval(Container.DataItem,"IDSanPham").ToString())%>
                                                          <div><a style=" color:red" target="_blank"  href="/orders-sold/<%#Eval("IDCarts") %>">Mã đơn hàng: #<%#DataBinder.Eval(Container.DataItem,"IDCarts").ToString()%> </a></div>
                                                    </td>
                                                      <td style="text-align: center;">
                                                        <%#DataBinder.Eval(Container.DataItem,"SoDiemThanhToan").ToString()%> điểm
                                                    </td>
                                                       ...
                                                       <td style="text-align: center;">
                                                           Duyệt điểm từ ví tạm giữ sang ví thương mại
                                                ...
                                                <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                                        <tr class="trHeader" style="height: 25px">
                                                            <th style="width: 4%; font-weight: bold;text-align:center" class="contentadmin">STT</th>
                                                             <th style="font-weight: bold; text-align:center">Người Mua</th>   
                                                            <th style="font-weight: bold; text-align:center;">Tên sản phẩm</th>
                                                            <th style="font-weight: bold; text-align:center">Số điểm thanh toán</th>
