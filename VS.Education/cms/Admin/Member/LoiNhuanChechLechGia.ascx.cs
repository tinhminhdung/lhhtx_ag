...
{
    public partial class LoiNhuanChechLechGia : System.Web.UI.UserControl
    {
        ...
        {
            string Namefile = "DanhSachLoiNhuanChenhLechGia_" + DateTime.Now;
            Response.Clear();
            ...
            if (dt.Count >= 1)
            {
                ...
                foreach (var item in dt)
                {
                    ...
                    sb.Append("    <td style=\"width:150px; vertical-align:middle;text-align: center;\">" + item.Type + "<br>" + ShowPro(item.IDProducts.ToString(), item.NoiDung.ToString()) + "</td>");
                    sb.Append("    <td style=\"width:150px; vertical-align:middle;text-align: center;\"><a target=\"_blank\" href=\"/admin.aspx?u=cartsNhanh&Code=" + item.IDCart.ToString() + "\">" + item.IDCart.ToString() + "</a></td>");
                    sb.Append("    <td style=\"width:400px; vertical-align:middle; text-align: center;\">" + Commond.ShowsThanhVien(item.IDThanhVien.ToString()) + "</td>");
                    sb.Append("    <td style=\"width:150px; vertical-align:middle;text-align: center;\">" + item.SoCoin + "</td>");
                    sb.Append("    <td style=\"width:520px; vertical-align:middle; text-align: center;\">" + item.NgayTao + "</td>");
                    sb.Append("</tr>");
                }
            }
            sb.Append("</table>");
