            ...
            <div class="bgContent">
                <div class="borderBlock_ListPro ">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" OnItemDataBound="ItemDataBound_RP">
                            <HeaderTemplate>
                                <table cellpadding="0" cellspacing="0" class="dcart scoll" width="100%" bgcolor="#FFFFFF" bordercolor="#C3C3C3">
                                    <tr class="procart">
                                        ...
                                        <td align="center"><strong>Điểm mua hàng</strong></td>
                                        <%-- <td align="center"><strong>Điểm chiết khấu vip</strong></td>--%>
                                        <td align="center"><strong><%=label("l_tomoney") %></strong></td>
                                        <td align="center" style="display: none"><strong>Điểm thưởng</strong></td>
                            ...
                            <ItemTemplate>
                                <tr align="center">
                                    ...
                                    <td align="center" class="TitleItem"><strong><%#Eval("Name")%></strong>
                                        <br />
                                        <%--<%#Eval("SanPhamChienLuoc")%>--%></td>
                                    <td align="center" class="TitleItem"><%#AllQuery.MorePro.FormatMoney_Cart(Eval("Price").ToString())%> </td>
                                    <td align="center" class="TitleItem">
                                        <asp:HiddenField ID="hiID" Value='<%# Eval("PID") %>' runat="server" />
                                        <asp:TextBox ID="txtxQuantity" Style="width: 40px; border: 1px solid #d7d7d7; text-align: center; margin: auto; padding: 0px;" Text='<%#DataBinder.Eval(Container.DataItem, "Quantity")%>' CssClass="txt_css" Width="40px" runat="server" OnTextChanged="txtxQuantity_TextChanged" AutoPostBack="true"></asp:TextBox>
                                    </td>
                                    <td align="center" class="TitleItem"><%#FormatMoneyDiemMuaHang(Eval("Money").ToString())%> </td>

                                    <%-- <td align="center" class="TitleItem"><%#(Eval("ChietKhau").ToString())%>-<%#(Eval("GiaChietKhauDaiLy").ToString())%></td>--%>

                                    <td align="center" class="TitleItem"><%#AllQuery.MorePro.FormatMoney_Cart(Eval("Money").ToString())%> </td>
                                    <td align="center" class="TitleItem" style="display: none"><%#FormatDiemMuaHang(Eval("TongDiemcoin").ToString())%> <%---Diemcoin:-<%# Eval("Diemcoin") %> -TongDiemcoin:-<%# Eval("TongDiemcoin") %> --%></td>
                                    <td align="center">
                            ...
                            <AlternatingItemTemplate>
                                <tr style="background: #fff5ee;">
                                    ...
                                    <%-- <td align="center" class="TitleItem"><%#(Eval("GiaChietKhauDaiLy").ToString())%></td>--%>
                                    <td align="center" class="TitleItem"><%#AllQuery.MorePro.FormatMoney_Cart(Eval("Money").ToString())%> </td>
                                    <td align="center" class="TitleItem" style="display: none"><%#FormatDiemMuaHang(Eval("TongDiemcoin").ToString())%> <%---Diemcoin:-<%# Eval("Diemcoin") %> -TongDiemcoin:-<%# Eval("TongDiemcoin") %>--%></td>
                                    <td align="center">
                                        <asp:LinkButton ID="LinkButton4" CommandName="delete" OnLoad="Delete_Load" CssClass="lnk" CommandArgument='<%#Eval("PID")%>' runat="server"><span class="cmdxoa"></span></asp:LinkButton></td>
                    ...
                    <table cellpadding="0" cellspacing="0" class="" width="100%" bgcolor="#FFFFFF" bordercolor="#C3C3C3" style="border: none">
                        ...
                        <asp:Panel ID="pndakichhoat" Visible="false" runat="server">
                            <tr>
                                <td height="30" colspan="6" align="right" class="TitleItem"><strong style="float: right; font-weight: bold; padding-right: 10px; color: red">Số điểm chiết khấu:</strong></td>
                                <td colspan="3" align="center" class="TitleItem"><strong style="color: red">
                                    <asp:Literal ID="ltsotienchietkhau" runat="server"></asp:Literal>
                                    / Điểm
                                </strong></td>
                            </tr>
                        ...
                        <asp:Panel ID="pnvivip" Visible="false" runat="server">
                            <tr>
                                <td height="30" colspan="6" align="right" class="TitleItem"><strong style="float: right; font-weight: bold; padding-right: 10px; color: red">Số điểm chiết khấu từ THƯỞNG MUA HÀNG:</strong></td>
                                <td colspan="3" align="center" class="TitleItem"><strong style="color: red">
                                    <asp:Literal ID="ltvivip" runat="server"></asp:Literal>
                                    / Điểm
                                            <asp:HiddenField Visible="false" ID="hdViVips" Value="0" runat="server" />
                                </strong></td>
                            </tr>
                        </asp:Panel>
                        <tr>
                            <td height="30" colspan="6" align="right" class="TitleItem"><strong style="float: right; font-weight: bold; padding-right: 10px; color: red">Số điểm phải thanh toán:</strong></td>
                            <td colspan="3" align="center" class="TitleItem"><strong style="color: red">
                                <asp:Literal ID="ltTongcanthanhtoansaukhichietkhaudaily" runat="server"></asp:Literal>
                                / Điểm
                            </strong></td>
                        </tr>
                        ...
                        <asp:Panel ID="pnKichHoat" Visible="false" runat="server">
                            <tr>
                                <td height="30" colspan="6" align="right" class="TitleItem"><strong style="float: right; font-weight: bold; padding-right: 10px;">Bạn được tặng ngay vào ví mua hàng:</strong></td>
                                <td colspan="3" align="center" class="TitleItem"><strong>
                                    <asp:Literal ID="lttangchothanhvien" runat="server"></asp:Literal>
                                    / Điểm
                                </strong></td>
                            </tr>
                            <tr>
                                <td height="30" colspan="6" align="right" class="TitleItem"><strong style="float: right; font-weight: bold; padding-right: 10px;">Nếu bạn trở thành đại lý sẽ được chiết khấu ngay vào đơn hàng:</strong></td>
                                <td colspan="3" align="center" class="TitleItem"><strong>
                                    <asp:Literal ID="ltchietkhaudaily" runat="server"></asp:Literal>
                                    / Điểm
                                </strong></td>
                            </tr>
                            <tr>
                                <td height="30" colspan="8" style="text-align: right">
                                    <asp:Button ID="bntkichhoat" CssClass="btnadd" OnClick="bntkichhoat_Click" Style="background: red !important" runat="server" Text="Bấm vào đây" />để trở thành đại lý với phí <b style="color: red"><%=Commond.Setting("TienKichHoat") %></b> điểm để được hưởng các quyền lợi của đại lý.
                                </td>
                            </tr>
                        </asp:Panel>
                    </table>
