<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GiaDaiLy.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.GiaDaiLy" %>
...
<div class="page-title m992">
    <h1 class="title-head margin-top-0"><a href="#">Quản lý giá bán lẻ cho đại lý</a></h1>
</div>
                        ...
                        <ItemTemplate>
                            <tr style="background-color: #f1f1f1" height="40">
                                <td style="text-align: center;">
                                    <%#MoreAll.MoreImage.Image_width_height_anhdaikdien(Eval("ImagesSmall").ToString(),"100","100")%>
                                </td>
                                <td style="text-align: center;">
                                    <b><%#Eval("Name")%></b>
                                </td>
                ...
                <ItemTemplate>
                    <tr style="background-color: #f1f1f1" height="40">
                        <td style="text-align: center;">
                            ...
                            <div class="chonsl">Chọn Số lượng từ bé đến lớn</div>
                            <asp:DropDownList ID="ddlsoluongtu" runat="server" AutoPostBack="true" CssClass="form-control giadailysca" OnSelectedIndexChanged="ddlsoluongtu_SelectedIndexChanged" Width="144px">
                            ...
                            <asp:DropDownList ID="ddlsoluongden" runat="server" AutoPostBack="true" CssClass="form-control giadailysca" OnSelectedIndexChanged="ddlsoluongden_SelectedIndexChanged" Width="144px">
                              <%--  <asp:ListItem Value="1">1</asp:ListItem>--%>
                                <asp:ListItem Value="2">2</asp:ListItem>
                                <asp:ListItem Value="3">3</asp:ListItem>
                                <asp:ListItem Value="4">4</asp:ListItem>
...
<div class="widget">
    ...
    <div class="widget-body">
        <div class='frm-add sssssssss'>
            <asp:Label ID="lblmsg" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label>
            <div class="frm_SanPham">
                <div class="cottongfrom">
                    <div class="Tieudesp">Số Lượng Từ</div>
                    <div class="froms">
                        <asp:DropDownList ID="ddlsoluongtu" CssClass="form-control giadailysca" runat="server"></asp:DropDownList>
                    </div>
                </div>
                <div class="cottongfrom">
                    <div class="Tieudesp">Số Lượng Đến</div>
                    <div class="froms">
                        <asp:DropDownList ID="ddlsoluongden" CssClass="form-control giadailysca" runat="server"></asp:DropDownList>
                    </div>
                </div>
                <div class="cottongfrom">
                    <div class="Tieudesp">Giá đại lý</div>
                    <div class="froms">
                ...
                <div class="cottongfrom">
                    <div class="Tieudesp">Thứ tự</div>
                    <div class="froms">
                        <asp:TextBox ID="txt_order" runat="server" ValidationGroup="GInfo" CssClass="txt_css" Width="45px">1</asp:TextBox>
            ...
            <div class="nutsukien">
                  <asp:LinkButton ID="btn_InsertUpdate" runat="server" OnClick="btn_InsertUpdate_Click" CssClass="toolbar btn btn-info" Style="background: #ed1c24"> <i class="icon-save"></i>  Cập nhật </asp:LinkButton>
