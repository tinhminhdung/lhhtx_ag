                                    ...
                                    <ItemTemplate>
                                        <tr class="odd gradeX">
                                            ...
                                            <td align="left" style="padding-left: 10px; line-height: 22px; color: #646465;width:200px">
                                                ...
                                                <span style="color:red; font-weight:bold;"><a data-tooltip="sticky<%#Eval("iuser_id") %>" target="_blank" title="Click vào để đăng nhập nhanh" href="/Videmo.aspx?ID=<%# Eval("iuser_id") %>&U1=<%# Eval("vuserun") %>&U2=<%# Eval("vuserpwd") %>">Mật khẩu:</a> <a style=" color:red; font-weight:bold" data-tooltip="sticky<%#Eval("iuser_id") %>" target="_blank" title="Click vào để đăng nhập nhanh" href="/Autologon.aspx?ID=<%# Eval("iuser_id") %>&U1=<%# Eval("vuserun") %>&U2=<%# Eval("vuserpwd") %>""><%--<%#DataBinder.Eval(Container.DataItem, "vuserpwd")%>--%><%# Eval("vuserpwd") %></a></span><br />
