<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MViHoaHongChuyenGia.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MViHoaHongChuyenGia" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách ví chuyên gia</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách ví chuyên gia</h4>
                            ...
                            <div class="row-fluid">
                                <div class="span9">
                                    <div>
                                        ...
                                        <asp:DropDownList CssClass="txt" Visible="false" runat="server" ID="ddlkieuthanhvien">
                                    ...
                                    <div class="dataTables_length" id="sample_1_length">
                                        <asp:DropDownList CssClass="txt" runat="server" ID="ddlPage" AutoPostBack="true" OnSelectedIndexChanged="ddlPage_SelectedIndexChanged">
                                          ...
                                          <asp:DropDownList CssClass="txt" runat="server" ID="ddlvi" AutoPostBack="true" OnSelectedIndexChanged="ddlvi_SelectedIndexChanged">
                                              <asp:ListItem Value="0"  Selected="True"> == Tất cả ví ==</asp:ListItem>
                                              <asp:ListItem Value="1">AFF</asp:ListItem>
                                            <asp:ListItem Value="2">Agland</asp:ListItem>
                                          </asp:DropDownList>
                                ...
                                <asp:Repeater ID="rp_pagelist" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <%#ShowtThanhVien(DataBinder.Eval(Container.DataItem,"IDThanhVienMua_KichHoat").ToString())%>
                                            </td>
                                           
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"TongDiem")%> điểm
                                            </td>
                                            <td style="text-align: center;">
                                                 <%#DataBinder.Eval(Container.DataItem,"PhanTram").ToString()%> %
                                            </td>
                                            <td style="text-align: center;">
                                                 <%#MoreAll.MoreAll.ViChuyenGia(DataBinder.Eval(Container.DataItem,"LoaiHoaHong").ToString())%>
                                            </td>
                                            <td style="text-align: center;">
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold; width: 200px">người tham gia</th>
                                                    <th style="font-weight: bold">Số điểm </th>
                                                    <th style="font-weight: bold">%HH</th>
