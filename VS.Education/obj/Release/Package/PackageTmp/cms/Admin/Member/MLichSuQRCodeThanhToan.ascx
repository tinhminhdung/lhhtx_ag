<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuQRCodeThanhToan.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MLichSuQRCodeThanhToan" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Lịch sử Thanh Toán QRCode</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Lịch sử Thanh Toán QRCode</h4>
                                    ...
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td>
                                             ...
                                             <td>
                                                <div><%#ShowtThanhVien(Eval("IDThanhVienNhan").ToString())%></div>
                                            </td>
                                            <td style="text-align: center;">
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold">Thành viên Chuyển</th>
                                                    <th style="font-weight: bold">Thành viên Nhận</th>
