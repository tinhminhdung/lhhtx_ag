<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List_HoaHongChuyeGia.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.List_HoaHongChuyeGia" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
   <h1 class="title-head">
        <span>Danh sách hoa hồng chuyên gia</span>
    </h1>
                        ...
                        <div class="dataTables_length" id="sample_1_length">
                            <div class="frm_hoahong">
                                <asp:DropDownList ID="ddlkieu" CssClass="form-control" AutoPostBack="true"
                                    ...
                                    <asp:ListItem Value="2">Hoa hồng agland</asp:ListItem>
                                </asp:DropDownList>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td style="text-align: left;">
                                   <%#ShowTrangThai(DataBinder.Eval(Container.DataItem,"LoaiHoaHong").ToString())%>
                                </td>
                                <td style="text-align: center;">
