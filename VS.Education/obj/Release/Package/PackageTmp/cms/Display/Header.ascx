                            ...
                            <li class="dropdown">
                                ...
                                <div id="myDropdown" class="dropdown-content" style="display: none">
                                    ...
                                    <asp:Panel ID="Panel6" Visible="false" runat="server">
                                        ...
                                        <div ><a href="/danh-sach-don-ban-hang.html">Quản lý đơn bán hàng (<asp:Literal ID="ltquanly" runat="server"></asp:Literal>)</a></div>
                                    </asp:Panel>
                                    ...
                                    <div ><a href="/chuyen-diem-vi-diem.html">Chuyển điểm trong ví điểm</a></div>
                                    <div><a href="/lich-su-chuyen-diem.html">Lịch sử chuyển điểm</a></div>
