                                ...
                                <asp:Repeater ID="rpitems" runat="server" OnItemCommand="rpitems_ItemCommand1">
                                    <ItemTemplate>
                                        <tr height="40">
                                            ...
                                            <td>
                                                <div style="margin-bottom: 4px; display: none"><span style="width: 15px;">N/Y:</span><asp:TextBox ID="txtgiacu" Style="width: 100px; text-align: center;" Text='<%#AllQuery.MorePro.FormatMoney_Cart(Eval("OldPrice").ToString())%>' onkeyup="valid(this,'quotes')" onblur="valid(this,'quotes')" CssClass="txt_css" runat="server"></asp:TextBox>VNĐ</div>
                                                <div style="margin-bottom: 4px;">
                                                    <span style="width: 15px;">Giá NY: </span>
                                                ...
                                                <div style="margin-bottom: 4px;">
                                                    <span style="width: 15px;">Giá Trả NCC: </span>
                            ...
                            <td>
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr valign="top">
                                        ...
                                        <td>Giá Gốc (Công ty)</td>
                                        <td>Giá bán thành viên Free</td>
                                        <td>Giá chiết khấu cho đại lý</td>
                                        <%--<td>Thành viên Free</td>--%>
                                        <td>Giá bán cho Ag</td>
                                        <td>Giá cửa hàng</td>
                                        <td style="display: none">Giá niêm yết</td>
                                    </tr>
                                    <tr valign="top">
                                        ...
                                        <td style="width: 100px">
                                            ...
                                            / Điểm
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server" FilterType="Numbers" TargetControlID="txtthanhvienFree"></cc1:FilteredTextBoxExtender>
                                        </td>
                                        <td style="width: 100px">
                                            ...
                                            / Điểm
                                                    <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server" FilterType="Numbers" TargetControlID="txtgiachietkhaudaily"></cc1:FilteredTextBoxExtender>
                                        </td>
                                        <%-- <td style="width: 100px">
                                        ...
                                        <td style="width: 100px">
                                            ...
                                            / Điểm
                                            <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server" FilterType="Numbers" TargetControlID="txtgiacuahang"></cc1:FilteredTextBoxExtender>
                                        </td>
