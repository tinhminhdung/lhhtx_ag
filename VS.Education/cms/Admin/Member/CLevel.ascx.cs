...
{
    public partial class CLevel : System.Web.UI.UserControl
    {
        ...
        protected void btn_InsertUpdate_Click(object sender, EventArgs e)
        {
            // try
            //{
            // && this.txtcontent.Text.Trim().Length < 1 && this.txtsocoin.Text.Trim().Length < 1
            if (this.txt_title.Text.Trim().Length < 1 && this.txtcapdo.Text.Trim().Length < 1 && this.txthoahong.Text.Trim().Length < 1)
            {
                ...
                if (str5 != null)
                {
                    if (!(str5 == "update"))
                    {
                        if (str5 == "insert")
                        {
                            ...
                            obj.Views = int.Parse(txtcapdo.Text);
                            obj.ShowID = 0;
                            ...
                            obj.Check_04 = 0;
                            obj.Check_05 = 0;
                            obj.Noidung1 = txthoahong.Text;
                            obj.Noidung2 = txtsocoin.Text;
                            obj.Noidung3 = txtcapdo.Text;
                            obj.Noidung4 = "";
                            obj.Noidung5 = "";
                            obj.Module = 31;
        ...
        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            ...
            {
                this.txt_order.Text = More.GetNextCateOrder(More.LV, this.lang, "-1").ToString();
            }
            else
            {
                this.txt_order.Text = More.GetNextCateOrder(More.LV, this.lang, hd_id.Value).ToString();
            }
        ...
        protected void rp_pagelist_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                ...
                case "EditDetail":
                    ...
                    if (table.Count > 0)
                    {
                        ...
                        if (table.Count > 0)
                        {
                            ...
                            txtsocoin.Text = table[0].Noidung2;
                            txtcapdo.Text = table[0].Views.ToString();
                            ...
                            txthoahong.Text = table[0].Noidung1.ToString().Trim();
                ...
                case "Delete":
                    ...
                    List<News> dtdetail = SNews.Name_Text("SELECT * FROM [News] WHERE icid IN(" + More.Sub_Menu(More.LV, str2) + ") order by Create_Date desc");
                    if (dtdetail.Count <= 0)
                    {
                        ...
                        SMenu.DELETE(More.Sub_Menu(More.LV, str2));
                        SMenu.DELETE(str2);
                        this.LoadItems();
                        this.ltmsg.Text = "";
                    }
        ...
        private void LoadItems()
        {
            try
            {
                ...
                // List<Entity.Menu> table = SMenu.CATE_LOADALL_NEWS(More.LV, this.lang, this.hd_id.Value.Trim());
                List<Entity.Menu> table = SMenu.Name_Text("SELECT * FROM Menu where capp='" + More.LV + "' and lang='" + lang + "' order by level,Orders asc");
        ...
        protected void btxoa_Click(object sender, EventArgs e)
        {
            try
            {
                for (int i = 0; i < rp_pagelist.Items.Count; i++)
                {
                    ...
                    if (chk.Checked)
                    {
                        List<News> dtdetail = SNews.Name_Text("SELECT * FROM [News] WHERE icid IN(" + More.Sub_Menu(More.LV, id.Value) + ") order by Create_Date desc");
                        if (dtdetail.Count <= 0)
                        {
                            ...
                            SMenu.DELETE_PARENT(More.Sub_Menu(More.LV, id.Value));
        ...
        //    SMenu.Name_Text("UPDATE [Menu] SET Orders=" + Orders.Text + " WHERE ID=" + b.Value + " and capp='" + More.LV + "'");
        //    LoadItems();
        ...
        protected void rp_pagelist_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                List<Entity.Menu> list = SMenu.Name_Text("SELECT * FROM Menu where capp='" + More.LV + "' and lang='" + lang + "' order by level,Orders asc");
        ...
        protected void ddlCaps_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                string sss = More.Level_ID(ddlCap.SelectedValue, More.LV);
                ...
                else
                {
                    if (list.Count > 0)
                    {
                        List<Entity.Menu> ab = SMenu.Name_Text("SELECT * FROM Menu where capp='" + More.LV + "' and Level='" + ddlCap.SelectedValue + "' and lang='" + lang + "' order by level,Orders asc");
                        {
                            try
                            {
        ...
        protected void bntcapnhat_Click(object sender, EventArgs e)
        {
            for (int i = 0; i < rp_pagelist.Items.Count; i++)
            {
                ...
                {
                    SMenu.Name_Text("UPDATE [Menu] SET Orders=" + txtOrders.Text + " WHERE ID=" + id.Value + " and capp='" + More.LV + "'");
