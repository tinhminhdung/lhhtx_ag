<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuThanhToanQRCode.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.MLichSuThanhToanQRCode" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
            <div class="nentrang">
                <h1 class="title-head">
                    <span>Danh sách lịch sử thanh toán QRCode</span>
                </h1>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    <td style="text-align: center;">
                                                      ...
                                                      <td style="text-align: center;">
                                                             <%#ShowtThanhVien(DataBinder.Eval(Container.DataItem,"IDThanhVienNhan").ToString())%>
                                                    </td>
                                                ...
                                                <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                                        <tr class="trHeader" style="height: 25px">
                                                            <th style="width: 4%; font-weight: bold;text-align:center" class="contentadmin">STT</th>
                                                             <th style="font-weight: bold; text-align:center">Người nhận</th>   
