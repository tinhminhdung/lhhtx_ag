<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ThongBaoChoToanNhaCungCap.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.settings.ThongBaoChoToanNhaCungCap" %>
...
<div id="cph_Main_ContentPane">
    <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
        <ul>
            ...
            <li class="Last"><span>Thông báo cho toàn bộ các nhà cung cấp</span></li>
        </ul>
    </div>
    <div style="clear: both;"></div>
    <div class="widget">
        <div class="widget-title">
            <h4><i class="icon-list-alt"></i>&nbsp; Thông báo cho toàn bộ các nhà cung cấp</h4>
        </div>
                ...
                <table style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
                    ...
                    <tr>
                        <td colspan="3" style="text-transform: uppercase">
                            ...
                            <strong>Thông báo cho toàn bộ các nhà cung cấp</strong>
                        </td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                        <td style="width: 78px">Số ngày hiển thị
                        </td>
                        <td style="padding-left: 15px"></td>
                        <td>
                            <asp:TextBox ID="txtngayhienthi" runat="server"></asp:TextBox>
                            <span style="font-size: 8pt; color: #ed1c24"><em>(Số ngày hiển thị)</em></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 15px"></td>
                        <td>
                            <CKEditor:CKEditorControl ID="txtnoiDungNCC" runat="server" Toolbar="Basic"></CKEditor:CKEditorControl>
