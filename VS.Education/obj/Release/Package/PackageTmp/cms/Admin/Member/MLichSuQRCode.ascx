<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuQRCode.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MLichSuQRCode" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Lịch sử Cấu hình hoa hồng QRCode</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Lịch sử Cấu hình hoa hồng QRCode</h4>
                        ...
                        <div class="widget-body">
                                ...
                                <asp:Repeater ID="rp_pagelist" runat="server"> <%--OnItemCommand="rp_pagelist_ItemCommand"--%>
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"ChietKhauHH")%> 
                                            </td>
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"HHNGuoiMua")%> 
                                            </td>
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"HHHeThong")%> 
                                            </td>
                                            <td>
                                        ...
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold">% HH Chiết khấu</th>
                                                    <th style="font-weight: bold">% HH người mua</th>
                                                    <th style="font-weight: bold">% HH hệ thống</th>
                            ...
                            <div style="color: red; text-align: right; padding-top: 7px; font-weight: 600">
                                <asp:Literal ID="lttongtien" runat="server"></asp:Literal></div>
                            <div style="color: red; text-align: right; padding-top: 7px; font-weight: 600">
                                <asp:Literal ID="lttongtienbangchu" runat="server"></asp:Literal></div>
                            <div style="color: red; text-align: right; padding-top: 7px; font-weight: 600">
                                <asp:Literal ID="ltCoin" runat="server"></asp:Literal></div>
