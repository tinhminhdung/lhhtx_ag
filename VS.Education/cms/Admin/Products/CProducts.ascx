                            ...
                            <div class="row-fluid">
                                <div class="span3">
                                    <div class="dataTables_length" id="sample_1_length">
                                        ...
                                        <asp:ListItem Value="20" Selected="True">Chọn số Bản ghi / Trang</asp:ListItem>
                                        <asp:ListItem Value="50">50 Bản ghi / Trang</asp:ListItem>
                                        ...
                                        <div><asp:Label ID="ltmsg" runat="server" Font-Bold="True" ForeColor="Red" ></asp:Label></div>
                                        ...
                                        <tr>
                                           ...
                                           <td>
                                            ...
                                            <td style="text-align: center;">
                                             ...
                                             <td style="text-align: center;">
                                                <asp:LinkButton CssClass="active action-link-button" CommandName="Check_01" CommandArgument='<%#Eval("ID")+"|"+Eval("Check_01")%>' runat="server" ID="Linkbutton8"><%#MoreAll.MoreAll.Enable(DataBinder.Eval(Container.DataItem, "Check_01").ToString())%></asp:LinkButton>
                                            </td>
                                            <td style="text-align: center;">
                                    ...
                                    <HeaderTemplate>
                                        <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="font-weight: bold;width:350px">Tên chuyên mục </th>
                                                    ...
                                                    <th style="font-weight: bold">Tab Giá tốt<br />Hôm nay</th>
                                                      <th style="font-weight: bold">Tab con <br />Menu</th>
                            ...
                            <td>
                                    ...
                                    <tr >
                                        ...
                                        <td>
                                            ...
                                            <asp:CheckBox ID="chknews"  CssClass="CsCheckBox" runat="server" Text="Giá tốt hôm nay" />
                                            <asp:CheckBox ID="CheckBox1" CssClass="CsCheckBox" runat="server" Text="Trang chủ - Tab Menu" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
