<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLichSuRutTien.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.MLichSuRutTien" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
            <div class="nentrang">
                <h1 class="title-head">
                    <span>Danh sách lịch sử rút điểm</span>
                </h1>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                  ...
                                                  <%--  <td style="text-align: center;">
                                                    ...
                                                    <td style="text-align: center;">
                                                        <%#AllQuery.MorePro.FormatMoney_NO(DataBinder.Eval(Container.DataItem,"SoTienCanRut").ToString())%> điểm
                                                    </td>
                                                      <td style="text-align: center;">
