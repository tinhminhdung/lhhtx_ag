<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LoiNhuanDangKyQRCode.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.LoiNhuanDangKyQRCode" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách lợi nhuận QRCode</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách lợi nhuận QRCode</h4>
                                ...
                                <div class="span9">
                                    <div>
                                        ...
                                        <asp:DropDownList CssClass="txt" runat="server" ID="ddlkieuthanhvien">
                                            <asp:ListItem Value="1">Người Chuyển</asp:ListItem>
                                            <asp:ListItem Value="2">Người Nhận</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <asp:Repeater ID="rp_pagelist" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="text-align: center;">
                                                <%#DataBinder.Eval(Container.DataItem,"SoDiemChuyen")%> điểm
                                            </td>
                                            ...
                                            <tbody>
                                                <tr class="trHeader" style="height: 25px">
                                                    ...
                                                    <th style="width: 4%; font-weight: bold; display: none;" class="contentadmin">No</th>
                                                        <th style="font-weight: bold; width: 200px">Nội dung </th>
                                                    <th style="font-weight: bold; width: 200px">Người chuyển điểm </th>
                                                    <th style="font-weight: bold; width: 200px">người nhận điểm</th>
