<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List_HoaHong_Ban.ascx.cs" Inherits="VS.E_Commerce.cms.Display.QuanLyDangBai.List_HoaHong_Ban" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<link type="text/css" rel="stylesheet" href="/Resources/admins/css/font-awesome.css" />
   <h1 class="title-head">
        <span>Danh sách hoa hồng nhà cung cấp</span>
    </h1>
