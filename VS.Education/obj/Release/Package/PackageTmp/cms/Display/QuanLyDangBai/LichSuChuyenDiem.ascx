...
<asp:DropDownList ID="ddlstatus" Visible="false" runat="server" CssClass="form-control droploc" AutoPostBack="true" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged" >
