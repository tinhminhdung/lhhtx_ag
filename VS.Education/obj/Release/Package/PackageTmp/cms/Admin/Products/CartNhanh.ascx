<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CartNhanh.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Products.CartNhanh" %>
    ...
    <div id="">
        <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
            <ul>
                ...
                <li class="Last"><span>Quản lý giỏ hàng - Duyệt Nhanh</span></li>
            </ul>
        </div>
            ...
            <asp:MultiView ID="MultiView1" runat="server">
                <asp:View ID="View1" runat="server">
                    <div class="widget-title">
                        <h4><i class="icon-list-alt"></i>&nbsp;Quản lý giỏ hàng - Duyệt Nhanh </h4>
                    </div>
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="span12">
                                <div class="dataTables_filter" id="sample_1_filter">
                                    ...
                                    <asp:DropDownList ID="ddltinhthanh" class="CSTextBox" OnSelectedIndexChanged="ddltinhthanh_SelectedIndexChanged"  ValidationGroup="GInfo" style="border-radius: 0px !important;height: 29px;border: 1px solid #d7d7d7;width: 17%;" AutoPostBack="true" runat="server"></asp:DropDownList>
                                   
                                       <asp:DropDownList ID="ddlmuahangkichhoat" Style="width: 320px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlmuahangkichhoat_SelectedIndexChanged">
                                        <asp:ListItem Value="-1" Selected="True">Tất cả đơn hàng</asp:ListItem>
                                        <asp:ListItem Value="1">Đơn hàng mua kích hoạt đại lý</asp:ListItem>
<%--                                        <asp:ListItem Value="2">Đơn hàng thông thường</asp:ListItem>--%>
                                    </asp:DropDownList>
                                    
                                     <asp:DropDownList ID="ddlstatus" Visible="false" Style="width: 320px" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlstatus_SelectedIndexChanged">
                                    ...
                                    <asp:DropDownList ID="ddltrangthainguoimuahang" Visible="false" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddltrangthainguoimuahang_SelectedIndexChanged">
                                   ...
                                   <ItemTemplate>
                                        <tr height="40">
                                            ...
                                            <td align="left" style="padding-left: 10px; line-height: 22px; color: #646465" width="300px">
                                                <div style="color: red; font-weight: bold"><a href="/admin.aspx?u=DetailCartNhanh&ID=<%# Eval("ID") %>">Mã đơn hàng: #<%# Eval("ID") %><%--  <%#ShowTTThanhVien(DataBinder.Eval(Container.DataItem, "IDThanhVien").ToString())%>--%></a> </div>
