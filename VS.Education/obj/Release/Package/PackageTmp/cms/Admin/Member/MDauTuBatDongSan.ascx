<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MDauTuBatDongSan.ascx.cs" Inherits="VS.E_Commerce.cms.Admin.Member.MDauTuBatDongSan" %>
    ...
    <div id="">
        <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
            <ul>
                ...
                <li class="Last"><span>Danh sách Đầu tư bất động sản</span></li>
            </ul>
        </div>
        ...
        <div class="widget">
            <asp:Panel ID="pn_list" runat="server" Width="100%">
                <div class="widget-title">
                    <h4><i class="icon-list-alt"></i>&nbsp;Danh sách Đầu tư bất động sản</h4>
                </div>
                <div class="widget-body">
                    <div class="row-fluid">
                        ...
                        <div class="span2">
                            <div class="dataTables_filter" id="sample_1_filter">
                                <asp:LinkButton ID="lnkxuatExel" Visible="false" runat="server" OnClick="lnkxuatExel_Click" CssClass="vadd toolbar btn btn-info"> Xuất Exel</asp:LinkButton>
                    ...
                    <div style="color: red">
                        <asp:Label ID="ltthongtin1" runat="server" Font-Bold="True" ForeColor="Red"></asp:Label></div>
