<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CapNhatThongTinTV.aspx.cs" Inherits="VS.E_Commerce.cms.Display.Members.CapNhatThongTinTV" %>
                        ...
                        <div class="wrap ">
                            ...
                            <div class="frm_Thanhvien">
                                ...
                                <div class="nenchokhoi" style=" display:none">
                                    ...
                                    <div class="gachke">
                                        <div class="tenthanhvien Otherthanhvien">Cấp độ (Level)</div>
                                        <div style="float: left">
                                    ...
                                    <div class="gachke">
                                        ...
                                        <div style="float: left">
                                            ...
                                            <asp:DropDownList ID="ddlvitien" runat="server">
                                                <asp:ListItem Value="1">Chọn Ví Quản lý</asp:ListItem>
                                                <asp:ListItem Value="2">Chọn Ví Thương Mại</asp:ListItem>
                                            </asp:DropDownList>
                                            <asp:Button ID="btkichhoat" Visible="false" Style="background: red; color: #fff; text-align: center; padding-left: 5px;" OnClick="btkichhoat_Click" runat="server" Text="Kích hoạt nạp tiền thành viên" />
                                        </div>
                                    </div>
                                    <div class="gachke">
                                ...
                                <div class="gachke">
                                    ...
                                    <div class="iconnthanhvien">
                                        <asp:TextBox CssClass='contact3' ID="txtname"  runat="server" Width="358px"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="gachke">
                                ...
                                <div class="gachke">
                                    ...
                                    <div class="DiaChi">
                                        <asp:TextBox CssClass='contact3' ID="txtaddress"  TextMode="MultiLine" Style="height: 70px" runat="server" Width="358px"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="gachke">
                                    ...
                                    <div class="iconnthanhvien">
                                        <asp:TextBox CssClass='contact3' ID="txtemail"  runat="server" Width="358px"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="gachke">
