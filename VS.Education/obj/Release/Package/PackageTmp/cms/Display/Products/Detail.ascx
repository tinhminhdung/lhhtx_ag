                            ...
                            <div class="col-xs-12 details-product">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-7 details-pro a-left">
                                        ...
                                        <div class="price-box">
                                            <div class="special-price">
                                                <span class="price product-price">Thành Viên (Thưởng):<asp:Literal ID="ltthuongthanhvien" runat="server"></asp:Literal></span>
                                            </div>
                                        </div>
                                        <div class="price-box">
                                            <div class="special-price">
                                        ...
                                        <div class="price-box">
                                            <div class="special-price">
                                                <span class="price product-price">Giá Cửa Hàng:
                                                    <asp:Literal ID="ltgiacuahang" runat="server"></asp:Literal></span>
                                            </div>
                                        </div>
                                        <div class="line">
